...
export default function WorkTogether() {
  return (
    <div className="max-w-6xl mx-auto mt-32 flex flex-col justify-center items-center text-center w-full md:w-200 px-5 md:px-0">
      ...
      <h1 className="text-3xl md:text-5xl mt-4 font-extrabold leading-[120%] tracking-[-1px]">
        Ready to transform your brand's digital experience?
      </h1>
      <p className="mt-8 text-abu w-full md:w-160 text-sm md:text-base leading-[160%] tracking-[0%]">
